...
<body onload="loadHome();">
    <script>
            ...
            function requestProductListByCategory(name){
                ...
                $.ajax({url:'../SearchForProductByCategoryServlet?categoryName='+name+'&date='+new Date().toString(),type:'Post',contentType:myData,datatype:'json',success:function(product){console.log(product);console.log(product.length); $("#productListDiv").html("");$("#productListDiv").append("<h3>Our Products </h3>"); for(i=0;i<product.length;i++){ $("#productListDiv").append("<div class=\"row-fluid\"><ul class=\"thumbnails\"><li class=\"span4\"><div class=\"thumbnail\"><a href=\"#\" name=\""+product[i].name+"\" onclick=\"requestProductDetails("+'name'+");\" class=\"overlay\"></a><a class=\"zoomTool\" href=\"#\" name=\""+product[i].name+"\" onclick=\"requestProductDetails("+'name'+");\" title=\"add to cart\"><span class=\"icon-search\"></span> QUICK VIEW</a><a href=\"#\" name=\""+product[i].name+"\" onclick=\"requestProductDetails("+'name'+");\"><img src=\"../assets/img/"+product[i].imgMaster+"\" alt=\"\"></a><div class=\"caption cntr\"><p>"+product[i].name+"</p><p><strong>"+product[i].price+"</strong></p><h4><a class=\"shopBtn\" href=\"#\" name=\""+product[i].price+"\" id=\""+product[i].id+"\" onclick=\"addProductToCart("+'id'+","+'name'+");\" title=\"add to cart\"> Add to cart </a></h4><div class=\"actionList\"></div> <br class=\"clr\"></div></div></li></ul></div>");}}});
            ...
            function requestProductListByName(){
                ...
                $.ajax({url:'../SerchProductByNameServlet?myProductName='+name+'&date='+new Date().toString(),type:'Post',contentType:myList,datatype:'json',success:function(product){console.log(product);$("#productListDiv").html("");$("#productListDiv").append("<h3>Our Products </h3>");if(product.categoryId!==0){$("#productListDiv").append("<div class=\"row-fluid\"><ul class=\"thumbnails\"><li class=\"span4\"><div class=\"thumbnail\"><a href=\"#\" name=\""+product.name+"\" onclick=\"requestProductDetails("+'name'+");\" class=\"overlay\"></a><a class=\"zoomTool\" href=\"#\" name=\""+product.name+"\" onclick=\"requestProductDetails("+'name'+");\" title=\"add to cart\"><span class=\"icon-search\"></span> QUICK VIEW</a><a href=\"#\" name=\""+product.name+"\" onclick=\"requestProductDetails("+'name'+");\"><img src=\"../assets/img/"+product.imgMaster+"\" alt=\"\"></a><div class=\"caption cntr\"><p>"+product.name+"</p><p><strong>"+product.price+"</strong></p><h4><a class=\"shopBtn\" href=\"#\" name=\""+product.price+"\" id=\""+product.id+"\" onclick=\"addProductToCart("+'id'+","+'name'+");\" title=\"add to cart\"> Add to cart </a></h4><div class=\"actionList\"></div> <br class=\"clr\"></div></div></li></ul></div>");}else{$("#productListDiv").append("<div class=\"row-fluid\"><ul class=\"thumbnails\">No Such Product</div>");}}});
            }
