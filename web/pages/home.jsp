...
<html>
    <head>
        ...
        <script>
            ...
            function requestProductDetails(name){
                console.log(name);
                myNewList=JSON.stringify("{categoryName:'"+name+"',date:'"+new Date().toString()+"'}");
                $.ajax({url:'../GetProductDetailsServ?productName='+name+'&date='+new Date().toString(),type:'Post',contentType:myNewList,datatype:'json',success:function(product){console.log(product);$(".row").html(product)}});
